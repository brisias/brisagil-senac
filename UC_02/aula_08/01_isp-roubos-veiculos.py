...
plt.suptitle('Análise dos Dados sobre Roubo de Veículos (2003-2024)', fontsize=15)

plt.subplot(2,2,1)
plt.title('Boxplot dos Roubos de Veículos', fontsize=13)
plt.boxplot(array_roubo_automoveis,vert=False,showmeans=True)

plt.subplot(2,2,2)
plt.title('Histograma dos Roubos de Veículos', fontsize=13)
...
plt.subplot(2,2,3)
plt.title('Outliers dos Roubos de Veículos', fontsize=13)
plt.barh(df_rb_auto_outliers_superiores_order['cisp'].astype(str),df_rb_auto_outliers_superiores_order['roubo_veiculo'])

plt.subplot(2,2,4)
plt.title('Medidas descritivas dos Roubos de Veículos', fontsize=13)
plt.axis('off')
plt.text(0.05,0.9,f'Média de Roubos de Veículos: {media_roubo_automoveis:.0f}', fontsize=11)
plt.text(0.05,0.75,f'Mediana de Roubos de Veículos: {mediana_roubo_automoveis:.0f}', fontsize=11)
plt.text(0.05,0.6,f'Distância entre a média e a mediana dos roubos de veículos: {distancia_roubo_automoveis:.2f}%', fontsize=11)
plt.text(0.05,0.45,f'Maior Valor de Roubos de Veículos: {maior_roubo_automoveis:.0f}', fontsize=11)
plt.text(0.05,0.3,f'Menor Valor de Roubos de Veículos: {menor_roubo_automoveis:.0f}', fontsize=11)
plt.text(0.05,0.15,f'O coeficiente de variação de Roubos de Veículos: {coeficiente_variacao_roubo_automoveis:.2f}', fontsize=11)
plt.text(0.05,0,f'A distância da variancia de Roubos de Veículos: {distancia_var_rb_auto:.2f}', fontsize=11)
plt.show()