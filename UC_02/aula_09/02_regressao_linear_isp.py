...
rcParams["figure.constrained_layout.h_pad"] = 0.1 # Espaco entre as linhas
rcParams["figure.constrained_layout.w_pad"] = 0.4 # Espaco entre as colunas

# Visualizando os Dados Analisados
print('\n- Visualizando os Dados Analisados -')
plt.subplots(3,3, layout='constrained' , figsize=(16,10))
